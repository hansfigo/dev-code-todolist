		...
		<div class="w-full flex flex-col mt-6 gap-6">
			...
			<div>
				...
				<div class="dropdown">
					...
					>
						<li>
							<a data-cy="modal-add-priority-item" on:click={() => (priority = "very-high")}>🔴 Very High</a>
						</li>
						<li>
							<a  data-cy="modal-add-priority-item" on:click={() => (priority = "high")}>🟠 High</a>
						</li>
						<li>
							<a  data-cy="modal-add-priority-item" on:click={() => (priority = "normal")}>🟢 Normal</a>
						</li>
						<li>
							<a  data-cy="modal-add-priority-item" on:click={() => (priority = "low")}>🔵 Low</a>
						</li>
						<li>
							<a  data-cy="modal-add-priority-item" on:click={() => (priority = "very-low")}>🟣 Very Low</a>
						</li>
					</ul>
				</div>
			</div>
