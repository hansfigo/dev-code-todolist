<script lang="ts">
	...
	import { activityDetail, activityDetailStore, activityTitleStore } from '$lib/utils/activityDetail.js';
...
<div class="mt-8 flex flex-col items-center h-[80vh] relative px-8">
	<div class="flex justify-between container">
		<div class="flex gap-4 items-center">
			...
			{#if $isEditing}
				<input bind:value={$activityTitleStore} on:blur={saveValue} type="text" class="text-2xl font-bold bg-transparent border-b-2 border-black"/>
			{:else}
